...
const HeroSection = () => {
    ...
    useEffect(() => {
        if (isMoveAnimation) {
            ...
            const featureImage = document.querySelector('.feature-image') as HTMLDivElement;
    ...
    return (
        <React.Fragment>
            <section className="hidden lg:flex flex-col">
                    ...
                    <div className="w-full h-full py-16 flex flex-col lg:flex-row px-4 2xl:px-0 2xl:w-360 items-center justify-between gap-10 xl:gap-20">
                        ...
                        <div className="w-full xl:w-1/2 hidden md:flex items-center justify-center gap-3.5 relative">
                            <motion.div initial={{ x: 0, y: 0 }}
                                ...
                                className="p-4 flex absolute top-5 gap-2 left-[5%] lg:right-75 bg-white rounded-lg ">
                                <div className="flex">
                                    {
                ...
                <section className="w-full relative flex items-center justify-center py-25" ref={featuresContainerRef}>
                    <div className="w-full h-full flex flex-col px-4 2xl:px-0 2xl:w-360 items-center justify-between gap-10 xl:gap-20">
                        <div className="flex flex-col gap-1">
                            {isLargeScreen ? (
                                <motion.h1 initial={{ y: -40, opacity: 0 }}
                                    ...
                                    className="text-[#932EFA] font-semibold leading-[150%]">Features</motion.h1>
                            ) : (
                                <h1 className="text-[#932EFA] font-semibold leading-[150%]">Features</h1>
                            )}
                            <div
                                className="w-full flex gap-10 justify-between">
                                <motion.div className="flex flex-col text-left w-[40%]"
                        ...
                        <div className="flex w-full">
                            ...
                            <div className="w-[40%] relative flex items-center min-h-140 justify-center ">
                                <Image src='/assets/hero-section/Mobile.png' alt="Mobile Image" width={280} height={500} className="feature-image invisible pointer-events-none" />
                            </div>
                            <div className="w-[30%] flex flex-col justify-between">
                                {
