...
const HeroSmallScreen = () => {
  return (
    <React.Fragment>
      <section
        className="w-full relative bg-cover flex items-center justify-center pt-10"
        style={{ backgroundImage: "url('/assets/imageBg.png')" }}
      >
        <div className="w-full h-full py-10 md:py-20 flex flex-col lg:flex-row px-4 2xl:px-0 2xl:w-360 items-center justify-between gap-10 xl:gap-20">
          <HeroContent />

          <div className="w-full xl:w-1/2 flex flex-row items-center justify-center gap-6 relative">
            <div className="flex flex-col gap-15">
              <div className="p-3 flex justify-start gap-3 bg-white rounded-lg md:self-center lg:translate-y-15">
                <div className="flex">
                  {avatarDetails.map((avatar) => (
                    <Image
                      ...
                      width={40}
                      height={40}
                      className="-ml-2 first:ml-0 rounded-full sm:h-10 sm:w-10 h-5 w-5"
                    />
                  ))}
                </div>

                <div className="flex flex-col">
                  <p className="text-text font-semibold">120K+</p>
                  <p className="text-muted font-normal text-[10px]">
                    Businesses Trust Payslate
                  </p>
                </div>
              </div>
              <div className="flex flex-col justify-center items-center">
                <div className="w-full max-w-75 bg-white h-fit p-5 rounded-lg shadow-[-20.4px_20.4px_30.61px_0px_rgba(46,104,253,0.08),0px_-16.32px_20.4px_0px_rgba(46,104,253,0.04)]">
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="w-full flex flex-col gap-5 justify-between">
              <div className="flex flex-col text-left">
                <h2 className="font-bold md:text-[40px] text-[28px] text-text leading-[120%]">
                  Your Data, Secured. Your Finances, Simplified.
                </h2>
              </div>
              <div>
                <p className="text-muted md:text-[18px] text-base leading-[150%]">
                  Payslate ensures your financial records are accurate,
                  auditable, and always protected with enterprise-grade security
