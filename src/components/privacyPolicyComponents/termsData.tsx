export const UsersMustData: string[] = [
...
export const ProfileCreationData: string[] = [
  "Transaction-related updates.",
  "Payment reminders.",
  "Service information and promotional offers.",
];

export const TerminationData: string[] = [
...
export const TransactionInformationData: string[] = [
...
export const ThirdPartyServicesDescription =
...
export const IntellectualPropertyDescription =
...
export const TerminationDescription =
...
export const WarrantiesDescription =
...
export const LiabilityDescription =
